export default {
  ...
  'dash.evaporator': 'ВИПАРНИК',
  'dash.evap_temp': 'Випарник',
  'dash.cond_temp': 'Конденсатор',
  'dash.differential': 'ДИФЕРЕНЦІАЛ',
  'prot.summary': 'Захист',
  'prot.ok': 'Норма',
  'prot.alarms': 'аварій',
  'prot.all_ok': 'Всі системи в нормі',
  'prot.checks_passed': 'перевірок пройдено',
  'prot.reset': 'Скинути аварії',
  'prot.diagnostics': 'Діагностика компресора',
  'diag.starts': 'Запусків/год',
  'diag.hours': 'Мотогодини',
  'diag.duty': 'Навантаження',
  'diag.runtime': 'Час роботи',
  'diag.last_run': 'Ост. цикл',
  'diag.last_off': 'Ост. простій',
