export default {
  ...
  'dash.door_open': 'DOOR',
  'dash.evaporator': 'EVAPORATOR',
  'dash.evap_temp': 'Evaporator',
  'dash.cond_temp': 'Condenser',
  'dash.differential': 'DIFFERENTIAL',
  'prot.summary': 'Protection',
  'prot.ok': 'OK',
  'prot.alarms': 'alarms',
  'prot.all_ok': 'All systems nominal',
  'prot.checks_passed': 'checks passed',
  'prot.reset': 'Reset alarms',
  'prot.diagnostics': 'Compressor diagnostics',
  'diag.starts': 'Starts/hr',
  'diag.hours': 'Motor hours',
  'diag.duty': 'Duty cycle',
  'diag.runtime': 'Run time',
  'diag.last_run': 'Last run',
  'diag.last_off': 'Last off',
  'state.idle': 'IDLE',
